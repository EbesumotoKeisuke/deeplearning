...
#保存したモデルの読み込み
model = model_from_json(open('Output/Debug2000data/test2_EqualData/tea_predict.json').read())
#保存した重みの読み込み
model.load_weights('Output/Debug2000data/test2_EqualData/tea_predict.hdf5')
